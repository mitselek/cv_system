CREATE MIGRATION m1o7somuo7zyq2isq3hnb2ulh3k2ojet3mcxu5qao7cqbtgr4ccatq
    ONTO initial
{
  CREATE SCALAR TYPE default::Translation EXTENDING std::json {
      CREATE CONSTRAINT std::expression ON (((std::len((<std::str>(__subject__)['et'] ?? '')) > 0) OR (std::len((<std::str>(__subject__)['en'] ?? '')) > 0))) {
