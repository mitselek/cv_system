...
**Projekti planeerimine, eelarve ja ajakava haldamine:**  
Eesti Kunstiakadeemias juhtisin kampuse LAN-võrgu rajamise (700+ kasutajat, mitu hoonet) ja e-posti migratsiooni (90% kulude kokkuhoid) projekte. Vastutasin nende projektiplaani, eelarve ja ajakava eest ning koordineerisin tehniliste meeskondade, administratsiooni, õppejõudude ja väliste partnerite tööd. Mõlemad projektid valmisid edukalt tähtajaks ja eelarve raames. PÖFF-i projektis jälgisin pidevalt töökoormust, sprintide mahtu ja progressi, tagades, et töö vastaks kvaliteedistandarditele ja toetaks ärilisi eesmärke.

**Riskide ja muudatuste haldamine:**  
30+ juurutusprojekti käigus olen õppinud kaardistama riske juba projekti algfaasis ja rakendama maandamismeetmeid. Olen juhtinud muudatusi scope'is, eelarves ja ajakavas, kooskõlastades neid kliendiga ning tagades muudatuste ärilise põhjendatuse. Entu platvormi juurutuste puhul on muudatuste haldamine olnud kriitilise tähtsusega, sest klientide vajadused on sageli täpsustunud või muutunud projekti käigus.

**Kommunikatsioon ja aruandlus:**  
Olen olnud peamine kontaktisik kliendi ja tiimi vahel kõigis Entu platvormi juurutustes. PÖFF-i projektis vastutasin selle eest, et kõik osapooled (festivali juhtkond, arendusmeeskond, välispartnerid) oleksid teadlikud projekti hetkeseisust, otsustest ja muudatustest. Olen koostanud projektiaruandeid ja taganud läbipaistva kommunikatsiooni kõigi sidusrühmade vahel.

**Tehniline pädevus:**  
Minu tugev tehniline taust (Python 9/10, JavaScript 9/10, süsteemiarhitektuur, andmebaasid) võimaldab mul suhelda tulemuslikult arendusmeeskondadega ja mõista tehnilisi väljakutseid. See tehniline pädevus aitab tagada ärieesmärkide ja tehniliste lahenduste kooskõla ning võimaldab mul osaleda tehnilistes aruteludes ja teha informeeritud otsuseid.

**Keeleoskus:**  
Minu eesti keel on emakeele tasemel ning inglise keele oskus on väga hea (C2 lugemine/kirjutamine/kuulamine, C1 rääkimine/esitlus), sealhulgas IT-spetsiifilises terminoloogias.
...
Tööpakkumises kirjeldatud esimesed väljakutsed - projekti ärilise väärtuse defineerimine, Scrum-protsesside juhtimine ja sidusrühmade kaasamine - on täpselt need valdkonnad, kus mul on kõige tugevam kogemus. Olen valmis kiiresti süvenema Askendi ärikonteksti, õppima teie klientide vajadusi ja andma oma panuse projekti edukasse elluviimisse.

Tänan Teid aja ja kaalumise eest. Olen meeleldi valmis kohtumisel arutama, kuidas minu kogemused saavad kaasa aidata Askendi projektide edule ja Eesti digiriigi tuleviku kujundamisele.
