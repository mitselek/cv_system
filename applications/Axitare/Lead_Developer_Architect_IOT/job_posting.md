...
- Helm, Docker/OCI-kontit, GitOps/CI/CD (esim. GitHub Actions, Argo CD)
- IaC-työkalut (esim. Terraform)
...
2. **Vähemmän byrokratiaa – enemmän vaikuttamista:** Axitare on riittävän pieni nopeaan päätöksentekoon, mutta riittävän vakaa tarjotakseen turvallisen ja pitkäjänteisen kasvualustan.

3. **Vaikutusvaltaa teknisiin päätöksiin:** Roolissa saat vaikuttaa järjestelmän pitkän aikavälin rakenteeseen, teknologioihin ja toimintatapoihin – kyseessä on aidosti lead-tason vaikuttajarooli.

4. **Moderni tech stack ja vahva panostus laatuun:** Käytämme moderneja teknologioita, jatkuvaa automaatiota ja hyviä kehityskäytäntöjä. Tietoturva ja luotettavuus eivät ole jälkikäteen lisättäviä asioita – ne ohjaavat arkkitehtuuria alusta alkaen.
